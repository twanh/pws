    ...
    def gather_folders_and_labels(self):
        ...
        for folder in os.listdir(root_dir):
            ...
            if os.path.isdir(folder_path):
                ...
                # FIXME: Take the file processing out of the folder loop (see issue #1 gh)

                # Loop trough files in the folder  
                # Limit at self.max_pictures
                for file in tqdm(os.listdir(folder_path)[:self.max_pictures]):
